...
{
    public partial class adsfd : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ad_name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    So_username = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    So_name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    So_email = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "A", "e4a29893-c9d2-4708-8445-1a97b3ca834e", "Administrator", "Administrator" },
                    { "B", "21b3b362-08fe-4c55-91e2-4d58ad695783", "Customer", "Customer" },
                    { "C", "3306f371-56d5-426d-b122-33d5b9e967b7", "StoreOwner", "StoreOwner" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Ad_name", "ConcurrencyStamp", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "1", 0, "Duc", "3a96612e-509c-4589-baed-ce8972649228", "Admin", "admin@fpt.com", true, false, null, null, "admin@fpt.com", "AQAAAAEAACcQAAAAEIfd+F8Oll0Hw2zugRPYn8rkHVp3k1rw9r8JyymfFnGpmrqmAsGgc3ffUzxyDdupew==", null, false, "62853338-9b7d-4c00-bb0a-568cbb2576f7", false, "admin@fpt.com" });
